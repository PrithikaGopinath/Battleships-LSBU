...
public interface ComputerPlayerStratergy {

    public interface ComputerPlayerStrategy {

        /**
         * Choose and return the coordinate of a square on the opponent's board to
         * attack.
         * The returned square should be a valid move (not already played).
         * Implementations could conceivably want to know the state of the computer's
         * own
        ...
        /**
         * After returning a chosen target from the above method, this method will be
         * called
